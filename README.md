...
A simple and interactive Tic Tac Toe game built using HTML, CSS, and JavaScript. This project allows two players to play the classic Tic Tac Toe game in a modern and responsive user interface.
...
```bash
git clone https://github.com/saurabh-2414/Tic-Tac-Toe-Game
```
